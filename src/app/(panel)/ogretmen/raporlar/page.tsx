  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted text-[14px] mt-0.5">Sinifinizdaki ogrencilerin sinav sonuclari</p>
      </div>
      ...
      {reports.length === 0 ? (
        <div className="bg-white rounded-2xl border border-form-border p-12 flex flex-col items-center gap-3">
          ...
          <p className="text-muted text-[14px]">Siniflandaki ogrenci bulunamadı veya henuz tamamlanmis sinav yok.</p>
        </div>
      ) : (
                ...
                {isOpen && (
                  <div className="border-t border-form-border divide-y divide-form-border">
                    {student.exams.length === 0 ? (
                      <div className="px-6 py-6 text-center text-muted text-[14px]">Tamamlanmis sinav bulunmuyor.</div>
